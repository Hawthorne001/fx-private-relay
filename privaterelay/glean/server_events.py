...
AUTOGENERATED BY glean_parser v20.0.1. DO NOT EDIT. To recreate, run:

bash .github/workflows/python_job.bash run build_glean
"""
...
class EventsServerEventLogger:
    ...
    def record(
        ...
        event_payload = {
            ...
            "client_info": {
                "telemetry_sdk_build": "glean_parser v20.0.1",
    ...
    def record_email_blocked(
        ...
        n_random_masks: int | None = None,
        n_domain_masks: int | None = None,
        n_deleted_random_masks: int | None = None,
        n_deleted_domain_masks: int | None = None,
        date_joined_relay: int | None = None,
        premium_status: str | None = None,
        date_joined_premium: int | None = None,
        has_extension: bool | None = None,
        date_got_extension: int | None = None,
        is_random_mask: bool | None = None,
    ...
    def record_email_mask_blocking_updated(
        self,
        user_agent: str | None = None,
        ip_address: str | None = None,
        fxa_id: str | None = None,
        ...
        """
        Record and submit a email_mask_blocking_updated event:
        A Relay user updates an email mask's blocking
        Event is logged to STDOUT via `sys.stdout.write`.
